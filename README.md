...
| `CLAUDE_MODEL` | non | `claude-haiku-4-5-20251001` | Modèle (mettre `claude-sonnet-4-6` pour + de qualité) |
| `SELLER_CONTEXT` | non | générique industrie | Ce que vend l'utilisateur (ciblage décideur) |
| `APOLLO_API_KEY` | non | — | Active les emails **vérifiés** via Apollo (sinon mode déduction) |
